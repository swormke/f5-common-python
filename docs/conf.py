...
htmlhelp_basename = 'F5PythonSDKdoc'
...
latex_documents = [
    (master_doc, 'F5PythonSDK.tex', u'F5 Python SDK Documentation',
...
man_pages = [
    (master_doc, 'f5pythonsdk', u'F5 Python SDK Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'F5PythonSDK', u'F5 Python SDK Documentation',
     author, 'F5PythonSDK', 'One line description of project.',
     'Miscellaneous'),
]
